...
- `CharacterComposer.ts` reads the combined MetroCity body/hair/outfit sheets under `public/assets/source/MetroCity/` and emits the same 3×7 layout. Preserve fallback to precomposited `char_0..5.png` when source sheets fail.
